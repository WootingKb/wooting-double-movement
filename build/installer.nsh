...
!macro installRedist
  ; Thanks to https://gist.github.com/bogdibota/062919938e1ed388b3db5ea31f52955c
  ...
  ;create temp dir
  CreateDirectory $TEMP\wooting-dm-setup
  ;download installer
  NSISdl::download "$VCRedistDownload" $TEMP\wooting-dm-setup\vcppredist.exe
  ;exec installer
  ExecWait "$TEMP\wooting-dm-setup\vcppredist.exe"
